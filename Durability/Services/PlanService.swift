...
class PlanService: ObservableObject {
    ...
    private func getAvailableMovements() async -> [Movement] {
        ...
        return [
            Movement(id: 1, name: "Squat", description: "Basic squat movement", videoURL: nil, jointsImpacted: ["ankle", "knee", "hip"], musclesImpacted: ["quad", "glute"], superMetricsImpacted: ["functional_strength"], sportsImpacted: ["Soccer", "Basketball"], intensityOptions: ["reps", "weight"], recoveryImpactScore: 0.3, resilienceImpactScore: 0.7, resultsImpactScore: 0.8, requiredEquipment: [], goalImpacts: [], bodyPartImpacts: [], injuryIndications: [], injuryContraindications: []),
            Movement(id: 2, name: "Deadlift", description: "Hip hinge movement", videoURL: nil, jointsImpacted: ["hip", "knee"], musclesImpacted: ["hamstring", "glute"], superMetricsImpacted: ["functional_strength"], sportsImpacted: ["Football"], intensityOptions: ["reps", "weight"], recoveryImpactScore: 0.2, resilienceImpactScore: 0.8, resultsImpactScore: 0.9, requiredEquipment: [], goalImpacts: [], bodyPartImpacts: [], injuryIndications: [], injuryContraindications: []),
            Movement(id: 3, name: "Rest", description: "Active recovery", videoURL: nil, jointsImpacted: [], musclesImpacted: [], superMetricsImpacted: [], sportsImpacted: [], intensityOptions: [], recoveryImpactScore: 0.9, resilienceImpactScore: 0.1, resultsImpactScore: 0.1, requiredEquipment: [], goalImpacts: [], bodyPartImpacts: [], injuryIndications: [], injuryContraindications: []),
            Movement(id: 4, name: "Walk", description: "Low intensity cardio", videoURL: nil, jointsImpacted: ["ankle", "knee", "hip"], musclesImpacted: ["quad", "hamstring"], superMetricsImpacted: ["aerobic_capacity"], sportsImpacted: ["Running"], intensityOptions: ["distance", "time"], recoveryImpactScore: 0.7, resilienceImpactScore: 0.3, resultsImpactScore: 0.2, requiredEquipment: [], goalImpacts: [], bodyPartImpacts: [], injuryIndications: [], injuryContraindications: [])
        ]
    }
