        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("Share your current training routine to help us personalize your experience")
                        .font(.subheadline)
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            HStack {
                                ...
                                Text("Upload Plan Image (Optional)")
                                    .font(.headline)
                                    .foregroundColor(.lightText)
                            }
                            ...
                            if let image = viewModel.trainingPlanImage {
                                VStack(spacing: 12) {
                                    ...
                                    HStack(spacing: 16) {
                                        ...
                                        // Note: In onboarding, we don't need to track removal since it's a fresh save
                                    }) {
                                            HStack(spacing: 6) {
...
struct CustomTextFieldStyle: TextFieldStyle {
    func _body(configuration: TextField<Self._Label>) -> some View {
        configuration
            .padding()
            .background(Color.darkerSpaceGrey)
            .cornerRadius(12)
            .foregroundColor(.lightText)
            .overlay(
                RoundedRectangle(cornerRadius: 12)
