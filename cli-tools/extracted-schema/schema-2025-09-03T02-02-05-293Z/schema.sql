...
-- Extracted on: 2025-09-03T02:02:05.287Z
...
-- Table: user_block_items
CREATE TABLE IF NOT EXISTS user_block_items (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  user_workout_block_id uuid NOT NULL,
  sequence smallint NOT NULL,
  movement_id uuid NOT NULL,
  movement_name_snapshot text NOT NULL,
  planned_dose jsonb DEFAULT '{}'::jsonb NOT NULL,
  base_dose_snapshot jsonb DEFAULT '{}'::jsonb NOT NULL,
  created_at timestamp with time zone DEFAULT now() NOT NULL,
  updated_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE IF NOT EXISTS user_set_logs (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  user_block_item_id uuid NOT NULL,
  set_number smallint NOT NULL,
  actual_metrics jsonb DEFAULT '{}'::jsonb NOT NULL,
  rpe_set numeric(4,1),
  pain_score smallint,
  notes text,
...
-- Table: user_workout_blocks
CREATE TABLE IF NOT EXISTS user_workout_blocks (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  user_workout_id uuid NOT NULL,
  sequence smallint NOT NULL,
  movement_block_id uuid NOT NULL,
  block_name_snapshot text NOT NULL,
  block_type_label_snapshot text NOT NULL,
  created_at timestamp with time zone DEFAULT now() NOT NULL,
  updated_at timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE user_block_items ADD CONSTRAINT user_block_items_movement_id_fkey FOREIGN KEY (movement_id) REFERENCES movements(id) ON UPDATE NO ACTION ON DELETE RESTRICT;
ALTER TABLE user_block_items ADD CONSTRAINT user_block_items_user_workout_block_id_fkey FOREIGN KEY (user_workout_block_id) REFERENCES user_workout_blocks(id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE user_programs ADD CONSTRAINT user_programs_program_id_fkey FOREIGN KEY (program_id) REFERENCES programs(id) ON UPDATE NO ACTION ON DELETE RESTRICT;
ALTER TABLE user_set_logs ADD CONSTRAINT user_set_logs_user_block_item_id_fkey FOREIGN KEY (user_block_item_id) REFERENCES user_block_items(id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE user_workout_blocks ADD CONSTRAINT user_workout_blocks_movement_block_id_fkey FOREIGN KEY (movement_block_id) REFERENCES movement_blocks(id) ON UPDATE NO ACTION ON DELETE RESTRICT;
ALTER TABLE user_workout_blocks ADD CONSTRAINT user_workout_blocks_user_workout_id_fkey FOREIGN KEY (user_workout_id) REFERENCES user_workouts(id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE user_workouts ADD CONSTRAINT user_workouts_user_program_id_fkey FOREIGN KEY (user_program_id) REFERENCES user_programs(id) ON UPDATE NO ACTION ON DELETE CASCADE;
